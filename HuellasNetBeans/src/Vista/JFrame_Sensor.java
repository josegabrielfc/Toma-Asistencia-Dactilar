...
public class JFrame_Sensor extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jBtnID, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jBtnEnrolOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEnrolOKActionPerformed
        ...
        int cont = 0;
// Obtener en cont el ultimo id que tiene guardado el arduino
        //String IdEnrolar = ++cont+"";
...
//--------------------------------------------------------------------------
    ...
    {
        private JFrame_Sensor jf = new JFrame_Sensor();
        ...
        public void serialEvent(SerialPortEvent arg0) {
            ...
            try
            {
                ...
                if(jf.getActivate()){
                    jf.setCodeID(Integer.valueOf(cadena.toString()));
                    jf.setActivate(false);
                }
